...
SELECT DISTINCT 'SELECT '+CHAR(39)+'MINDATE'+CHAR(39)+', MIN(YEAR(['+ a.COLUMN_NAME +'])), '+CHAR(39)+'MAXDATE'+CHAR(39)+', MAX(YEAR(['+ a.COLUMN_NAME +'])), '+CHAR(39)+''+ a.TABLE_CATALOG +'.'+ a.TABLE_SCHEMA +'.'+ a.TABLE_NAME + '.' + a.COLUMN_NAME +''+CHAR(39)+' FROM ['+ a.TABLE_SCHEMA +'].['+ a.TABLE_NAME +'] ORDER BY 1;' 
...
WHERE  (((a.DATA_TYPE = 'DATE') OR (a.DATA_TYPE = 'DATETIME') OR (a.DATA_TYPE = 'DATETIME2') OR (a.DATA_TYPE = 'TIMESTAMP')) AND (b.TABLE_TYPE = 'BASE TABLE'))
...
AND ((a.TABLE_NAME NOT IN ('ACADEMIC_CONTRACTS'
,'AcademicContract'

...
SELECT DISTINCT 'SELECT '+CHAR(39)+'MINDATE'+CHAR(39)+', MIN(substring(cast(['+ a.COLUMN_NAME +'] as varchar(10)),1,4)), '+CHAR(39)+'MAXDATE'+CHAR(39)+', MAX(substring(cast(['+ a.COLUMN_NAME +']as varchar(10)),1,4)), '+CHAR(39)+''+ a.TABLE_CATALOG +'.'+ a.TABLE_SCHEMA +'.'+ a.TABLE_NAME + '.' + a.COLUMN_NAME +''+CHAR(39)+' FROM ['+ a.TABLE_SCHEMA +'].['+ a.TABLE_NAME +'] ORDER BY 1 DESC;' 
...
WHERE ((a.DATA_TYPE = 'INT') AND (b.TABLE_TYPE = 'BASE TABLE'))
